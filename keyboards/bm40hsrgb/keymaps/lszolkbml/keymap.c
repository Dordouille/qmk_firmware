...
//define layers
enum layers {BASE, NAVR, NUMBER, ACCENT, COLORS, CODE, SECCODE, GAME, SECGAME};
...
if(IS_LAYER_ON(NAVR)) {
  ...
  rgb_matrix_set_color(33, 255, 100, 0);
  rgb_matrix_set_color(34, 255, 100, 0);
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_planck_mit(
    ...
    KC_LCTL,  MO(NAVR),  KC_LALT,    KC_LGUI,  MO(ACCENT),       KC_SPC,           MO(NUMBER), KC_LEFT,  KC_UP,   KC_DOWN,  KC_RGHT
  ),

//layers
  [NAVR] = LAYOUT_planck_mit(
    RGB_TOG,    RGB_VAI, RGB_SAI, RGB_HUI, RGB_MOD,  RGB_SPI, KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_RST,
    KC_NO,      RGB_VAD, RGB_SAD, RGB_HUD, RGB_RMOD, RGB_SPD, KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    TG(COLORS), KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,   KC_NO,  KC_NO,   KC_NO,   KC_BTN1, KC_BTN2, KC_ENT,
    TG(GAME),   KC_NO,   KC_NO,   KC_NO,   KC_NO,        KC_BSPC,     KC_NO,   KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R
  ),
  [NUMBER] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_NO,     KC_LALT,  KC_UNDS,     KC_NO,          KC_SPC,        KC_NO,    KC_HOME,  KC_PGUP,  KC_PGDN, KC_END
  ),
  [ACCENT] = LAYOUT_planck_mit(
    KC_GRV,  KC_EXLM,   KC_AT,    KC_HASH,     KC_DLR,    KC_PERC,  KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN, KC_BSPC,
    KC_TAB,  KC_NO,     KC_NO,    KC_NO,       KC_NO,     KC_NO,    KC_NO,    KC_MINS,  KC_EQL,   KC_LBRC,  KC_RBRC, KC_BSLS,
    KC_LSFT, KC_NO,     KC_NO,    KC_NO,       KC_NO,     KC_NO,    KC_NO,    KC_DEL,   KC_COMM,  KC_DOT,   KC_SLSH, KC_ENT,
    KC_LCTL, KC_NO,     KC_LALT,  KC_UNDS,     KC_NO,          KC_SPC,        KC_NO,    KC_MPRV, KC_VOLU, KC_VOLD, KC_TD(TD_MEDIA)
  ),
